...
export class Backend implements backendInterface {
    ...
    async addFavorite(arg0: bigint, arg1: string): Promise<void> {
    ...
    async getAllPrayers(): Promise<Array<Prayer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPrayers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllRituals(): Promise<Array<Ritual>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllRituals();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFavorites(): Promise<Array<FavoriteItem>> {
        if (this.processError) {
            try {
    ...
    async getFullSchedule(): Promise<Array<ScheduleItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFullSchedule();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPrayerCompletionsForDate(arg0: string): Promise<Array<bigint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPrayerCompletionsForDate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPrayersByCategory(arg0: string): Promise<Array<Prayer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPrayersByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markPrayerCompleted(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markPrayerCompleted(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeFavorite(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeFavorite(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
